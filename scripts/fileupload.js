        ...
        reader.onload = function (e) {
            ...
            img.addEventListener('click', (event) => {
                if (counter <= 1) {
                    ...
                    div1.setAttribute('class', 'divButton');
                    ...
                    counter++;
                    if (counter === 2) {
                        let width = coords.point2.x - coords.point1.x;
                        let height = coords.point2.y - coords.point1.y;
                        ...
                        let position = {
                            x: Math.min(coords.point1.x, coords.point2.x),
                            y: Math.min(coords.point1.y, coords.point2.y)
                        }
